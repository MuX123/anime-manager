...
<div class="cyber-core-v39" style="position: absolute; top: 0; left: 0; bottom: 0; display: flex; flex-direction: column; align-items: center; gap: 10px; padding: 12px 8px; background: transparent; border-left: 4px solid ${ratingColor}; z-index: 10; transition: all 0.3s ease;">
